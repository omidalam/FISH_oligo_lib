...
```{r, eval=T,echo=FALSE}
oil_phase<-data.frame(Component= c("Span 80","Tween 80", "Triton X-100", "Mineral oil"),Final_conc=c("4.5% (vol/vol)","0.4% (vol/vol)","0.05% (vol/vol)",""),vol_5ml=c("225µl","20µl","2.5µl","to 5ml"),vol_25ml=c("1.125ml","100µl","12.5µl","to 25ml"), vol_50ml=c("2.25ml", "200µl", "25µl", "to 50ml"))
colnames(oil_phase)<- c("Component", "Final concentration", "For 5ml","For 25ml","For 50ml")
oil_phase %>%
  kable(booktab=T) %>%
