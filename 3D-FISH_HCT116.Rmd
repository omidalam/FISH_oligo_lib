...
3D DNA-FISH in HCT116 cells, which with minor optimization can be used for all adherent cells.
...
## Day 3: Cell Preparation
###EdU labelling
1. _Optional_: Pulse cell with EdU by changing the media with media containing 5$\mu$M EdU. Incubate for 10 minutes.
    - Proceed to CLICK RX! a
...
1. Rinse the cells briefly in SSC/Tween (0.2% [v/v] Tween 20 in 4X SSC). Transfer coverslips to a humid chamber. 
1. Wash once in 4X SSC at RT, 5 min.

### Probe Detection
1. Block with 4X SSC/0.1% Triton X-100/4% BSA (Blocking buffer) at RT, for 30 min in a humid chamber.
...
1. Wash with 4X SSC/0.1% Triton X-100 at RT, shaking 3x 5min.

### EdU click reaction

### DNA counterstaining and mounting
1. Mount in DAPI containing mounting media.
    - Alternatively, you can counterstain with DAPI (0.05$\mu$g/ml in 4X SSC) at RT for 5 min. Wash briefly in 4X SSC/0.1% Triton X-100.
1. If using hardening mounting media, wait overnight for curing.
1. Seal coverslips with colorless nail polish and store at 4&deg;C.
    - FISH signals should be stable for at least 1 year.
